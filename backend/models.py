"""SQLAlchemy models. If SQLAlchemy isn't available or fails to import,
provide lightweight placeholders so the app can run in demo mode.
"""
import json
...
try:
    ...
    # SQLAlchemy unavailable: provide dummy Base and simple placeholder classes
    Base = object
